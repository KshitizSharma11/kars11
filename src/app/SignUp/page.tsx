          ...
          <div>
            <form className="space-y-4 mt-4">
              ...
              <div className=" flex flex-row items-center justify-center gap-8 mt-4">
               <FaGoogle size={64} className="p-4 rounded-lg bg-black text-white hover:bg-orange-500 cursor-pointer"/>
               <FaFacebook size={64} className="p-4 rounded-lg bg-black text-white hover:bg-orange-500 cursor-pointer"/>
              </div>
            </form>
          </div>
        </div>
